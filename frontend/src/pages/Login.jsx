          ...
          <section className='text-center'>
            <form onSubmit={onSubmit}>
              <div className=''>
                <input
                  type='email'
                  className=' duration-[300ms] rounded-lg w-[70%] md:w-[30%] px-4 py-2.5 mb-2 outline-none'
                  id='email'
                  name='email'
                  value={email}
              ...
              <div className='my-2'>
                <button className=' bg-black hover:scale-[1.01] duration-[300ms] text-white drop-shadow-2xl py-[10px] px-[20px]  rounded-lg nun-font-600 '>
                  Login
                </button>
              </div>
            </form>
            ...
            <div className='duration-[300ms] mt-1'>
              <Link to='/register' >
